...
import { PrismaClient } from "/Users/sr/Megahertz_BE/src/generated/prisma/index.js"
...
app.get('/success/:id',async (req:Request,res:Response):Promise<any>=>{
  console.log(req.params)
    ...
    let response:{
      ...
      products:string,
      status:string
    }|null=await prisma.txn.findFirst({
      where:{id:id},
      select:{
        id:true,
        userEmail:true,
...
app.get('/failure/:id',async (req:Request,res:Response):Promise<any>=>{
    const  id = Number(req.params.id);
